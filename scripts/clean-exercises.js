...
// Build the clean exercises file
// A1-A2: IDs 1-10 original, 61-80 new = 30 total
// B1: IDs 11-25 original, 81-100 new = 35 total  
// B2: IDs 26-40 original, 101-115 new = 30 total
// C1: IDs 41-50 original, 131-140 new = 20 total
// C2: IDs 51-60 original, 151-160 new = 20 total

// Synonym: A1-A2: 6 (1,2 + 13,14,15,16), B1: 9 (3,4,5 + 17-22), B2: 9 (6,7,8 + 23-27), C1: 6 (9,10 + 28,29,30), C2: 6 (11,12 + 31,32)

const exercises = `import type { Level } from '@/context/LevelContext'
...
const outPath = path.join(__dirname, '..', 'src', 'data', 'vocabulary-exercises.ts');
fs.writeFileSync(outPath, exercises.trim() + '\n', 'utf8');
console.log('✓ Rewrote vocabulary-exercises.ts with clean data');
console.log('File size:', exercises.length, 'bytes');
